...
exports.registerUser = async (req, res, next) => {
  ...
  try {
    ...
    res
      .status(201)
      .send({ message: "User registered successfully", payload: userResponse });
  } catch (err) {
    console.log(err);
...
exports.updateUser = async (req, res, next) => {
  ...
  try {
    ...
    res
      .status(200)
      .send({ message: "User updated successfully", payload: userResponse });
  } catch (err) {
    console.log(err);
...
exports.deleteUser = async (req, res, next) => {
  ...
  if (!enteredPassword) {
    return res
      ...
      .send({
        message:
          "Password is required in the request body to delete the account.",
      });
  }
  ...
  try {
    ...
    if (!isPasswordCorrect) {
      return res
        .status(401)
        .send({ message: "Incorrect password. Account deletion denied." });
    }
    ...
    res
      .status(200)
      .send({
        message: "User deleted successfully after password verification.",
      });
  } catch (err) {
